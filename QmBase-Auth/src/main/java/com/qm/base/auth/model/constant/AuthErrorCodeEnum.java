...
public enum AuthErrorCodeEnum {
    ...
    AUTH_USERNAME_INVALID("AUTH_USERNAME_INVALID", "用户名格式错误"),
    AUTH_EMAIL_INVALID("AUTH_EMAIL_INVALID", "邮箱格式错误"),
    AUTH_PHONE_INVALID("AUTH_PHONE_INVALID", "手机号格式错误"),
    AUTH_ACCOUNT_EXIST("AUTH_ACCOUNT_EXIST", "账号已存在"),
    AUTH_VERIFICATION_CODE_EMPTY("AUTH_VERIFICATION_CODE_EMPTY", "验证码为空"),
    AUTH_VERIFICATION_CODE_ERROR("AUTH_VERIFICATION_CODE_ERROR", "验证码错误"),
    AUTH_IDENTIFIER_TYPE_INVALID("AUTH_IDENTIFIER_TYPE_INVALID", "类型错误"),
    // 登录相关
    ...
    AUTH_PASSWORD_INVALID("AUTH_PASSWORD_INVALID", "密码格式错误"),
    AUTH_PASSWORD_NOT_SET("AUTH_PASSWORD_NOT_SET", "密码未设置"),
    AUTH_CREDENTIAL_EMPTY("AUTH_CREDENTIAL_EMPTY", "用户名或密码为空"),
    AUTH_ACCOUNT_DISABLED("AUTH_ACCOUNT_DISABLED", "账号被禁用"),
    AUTH_ACCOUNT_LOCKED("AUTH_ACCOUNT_LOCKED", "账号被锁定"),
    AUTH_ACCOUNT_NOT_EXIST("AUTH_ACCOUNT_NOT_EXIST", "账号不存在"),
    // 密码重置相关
    AUTH_EMAIL_OR_PHONE_EMPTY("AUTH_EMAIL_OR_PHONE_EMPTY", "邮箱或手机号码为空"),
    AUTH_EMAIL_OR_PHONE_NOT_EXIST("AUTH_EMAIL_OR_PHONE_NOT_EXIST", "邮箱或手机号码未注册"),
    AUTH_EMAIL_OR_PHONE_INVALID("AUTH_EMAIL_OR_PHONE_INVALID", "邮箱或手机号码格式错误"),
    AUTH_PASSWORD_EMPTY("AUTH_PASSWORD_EMPTY", "密码为空"),
    // 第三方登录
